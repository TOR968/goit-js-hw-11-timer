  ...
  _createClass(CountdownTimer, [{
    ...
    value: function startCountdown() {
      ...
      this.intervalId = setInterval(function () {
        ...
        _this.remainingTime = _this.targetDate - _this.currentTime;
        _this.timeCounter(), _this.insertTimeIntoMarckup();
    ...
    key: "insertTimeIntoMarckup",
    value: function insertTimeIntoMarckup() {
      this.refs = {
...
var countdownTimer = new CountdownTimer("#timer-1", "October 25, 2020, 16:01");
